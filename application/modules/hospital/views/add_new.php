                ...
                <div class="adv-table editable-table ">
                    ...
                    <form role="form" id="addNewHospital" action="hospital/addNewHospital" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control selectpicker countrypicker m-bot15" data-live-search="true" data-flag="true" <?php if (!empty($hospital->id)) { ?>data-default="<?php echo $hospital->country; ?>" <?php } else { ?> data-default="United States" <?php } ?>
                                    name="country">
                            </select>
                        </div>
...
<script type="text/javascript">var permited_modules = "<?php echo lang('permited_modules'); ?>";</script>
