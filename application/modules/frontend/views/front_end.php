...
<html>
    ...
    ?>
    <head><base href="<?php echo base_url(); ?>frontend">
        <meta charset="utf-8" />
        ...
        <link href="front-end/assets/5f16ec24d8bd7908a5d24625/css/partnerstack-1-9.b8e0fab07.min.css" rel="stylesheet"
              type="text/css" />

        <script src="front-end/ajax/libs/webfont/1.6.26/webfont.js" type="text/javascript"></script>
        <script type="text/javascript">WebFont.load({google: {families: ["Inter:100,200,300,regular,500,700"]}});</script>


        <link href="uploads/favicon.png"
    ...
    <body class="body">
        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" data-doc-height="1" role="banner"
             class="l-nav-section _w-nav w-nav">
            <div class="navigation-banner">
                <div class="text-block-101">
                    <span class="text-span-4"><?php echo lang('new'); ?> : </span> <span class="span_color"> <?php echo $settings->block_1_text_under_title; ?> →</span></div></div>
            <div class="l-nav-section__grid w-container">
                ...
                <nav role="navigation" id="w-node-ebd691a6-3a22-9b70-2dae-f440aac15826-aac15824" class="c-nav-menu w-nav-menu">
                    ...
                    <a href="frontend#book" class="c-button__secondary is--small w-inline-block" data-ix="button-icon">
                        <div class="c-button__text is--purple is--small"><?php echo lang('register_hospital'); ?></div><img
                            src="front-end/assets/5f16ec24d8bd7908a5d24625/5f3d46263a5ec7752b5a63df_Arrow_purple.svg"
                            width="32" height="32" alt="" class="c-button__icon is--small" />
                    </a></nav>
        ...
        foreach ($slides as $slide) {
            ...
            <div class="l-section is--hero" id="cover">
                <div class="w-layout-grid c-hero"><img
                        src="<?php echo $slide->img_url; ?>"
                        loading="lazy" width="595" id="w-node-_0ecfaf60-79bd-5d71-c1f8-96b64e9d0db0-fd5d4922"
                        alt="Illustration of a man sitting at a desk in front of a computer. Dotted lines connect the computer to portraits of different types of partner. "
                        class="c-hero__image" />
                    <div id="w-node-_4781c85d-0ce2-032e-fd4d-6f516a5efda1-fd5d4922" class="c-hero__copy">
                        <div id="w-node-_4e4fa717-af22-91dc-7b5b-71872c988dde-fd5d4922" class="c-hero__container w-clearfix">
                            ...
                            <p class="c-paragraph is--large"><?php echo $slide->text2; ?></p><a href="frontend#book" class="c-button__primary w-inline-block"
                                                                                                data-ix="button-icon">
                                <div class="c-button__text"><?php echo lang('register_hospital'); ?> </div><img
                                    src="front-end/assets/5f16ec24d8bd7908a5d24625/5f3d419ec0cff23f8b7b1a45_Arrow_white.svg"
                                    width="48" height="48" alt="" class="c-button__icon is--large" />
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="l-section is--condensed is--purple l-section__g2">
            ...
            <div id="w-node-_4b4b5bc8-7f53-fd0d-b339-8472a8992f59-fd5d4922" class="image-container"><img
                        src="<?php echo $settings->market_image; ?>"
                        loading="lazy"
                        class="ps-cust-logos-1 ps-cust-logos-g2" /></div>
            ...
            <div class="l-grid__general l-grid__g2quotes">
                <div id="contact-home" class="c-card g2-quote w-node-b0976b4d-0227-4222-d266-5fd411407afe-fd5d4922">
                    <div class="w-layout-grid grid">
                        ...
                        <p id="w-node-_83b66fe7-4a72-a4be-93ae-5a569d3218d5-fd5d4922" class="c-paragraph is--small is--hidden"><span
                                class="text-span-3">✓</span> <?php echo $settings->verified_1; ?></p><img
                            src="<?php echo $settings->comment_logo_1; ?>"
                            loading="lazy" id="w-node-_8f52ba6a-f2cf-0dbc-cd77-edc6e0e999cf-fd5d4922" alt="" class="g2-quote-stars" />
                    </div>
                </div>
                <div id="contact-home"
                     class="c-card g2-quote hidden-mobile w-node-_34a9e484-6736-d378-28a4-c2afe1ee68b0-fd5d4922">
                    <div class="w-layout-grid grid">
                        ...
                        <p id="w-node-bc56b118-a6c9-8bb4-437b-44aa020473c2-fd5d4922" class="c-paragraph is--small is--hidden"><span
                                class="text-span-3">✓</span> <?php echo $settings->verified_2; ?></p><img
                            src="<?php echo $settings->comment_logo_2; ?>"
                            loading="lazy" id="w-node-_34a9e484-6736-d378-28a4-c2afe1ee68b9-fd5d4922" alt="" class="g2-quote-stars" />
                    </div>
                </div>
            </div>
        ...
        <div id="partnership" class="l-section l-section__features">
            ...
            <div class="c-feature">
                ...
                <img src="<?php echo $settings->partner_image_1; ?>" loading="lazy"
                     alt="illustration of channel UI " data-w-id="0146308e-05a6-6206-6134-03da43d54c80"
                     id="w-node-_0146308e-05a6-6206-6134-03da43d54c80-fd5d4922" class="c-feature__image" />
            </div>
            <div class="c-feature">
                <img src="<?php echo $settings->partner_image_2; ?>"
                     loading="lazy" alt="illustration of partner performance UI"
                     data-w-id="96290585-20fc-d856-5f18-33e990a296aa c_feature_image" id="w-node-_96290585-20fc-d856-5f18-33e990a296aa-fd5d4922"
                     class="c-feature__image is--right" />
            ...
            <div class="c-feature is--last">
                ...
                <img src="<?php echo $settings->partner_image_3; ?>" loading="lazy"
                     alt="illustration of payout&#x27;s UI" data-w-id="0c959c90-d9b0-390a-e2d2-06e1a0359692" 
                     id="w-node-_0c959c90-d9b0-390a-e2d2-06e1a0359692-fd5d4922" class="c-feature__image" />
            </div>
        </div>
                    ...
                    <form action="frontend/addNewHospitalPayment" class="clearfix" id="addNewHospital" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-6 country_div">
                                ...
                                <select class="form-control selectpicker countrypicker"  data-live-search="true" data-flag="true" required=""
                                        name="country"></select>
                            </div>
...
//   $packages1 = ksort($all_packages);
                                ...
                                <div class="col-lg-4 col-sm-4 package_div">
                                    <div class="pricing-table">
                                        <div class="pricing-head">
                                            <h1 <?php if ($package1->recommended == 'Yes') { ?> class="recommended_div" <?php } else { ?>
                                                                                                    class="recommended_div1"
                                                                                                <?php } ?>
            ...
            <div class="l-grid__general">
                <div id="w-node-dc6d6587-dc91-094d-f21a-04d2bc4c8090-fd5d4922" class="l-container">
                    ...
                    <a href="frontend#book"
                       class="c-button__secondary extra--space w-inline-block" data-ix="button-icon">
                        <div class="c-button__text is--purple"><?php echo lang('register_hospital'); ?> <?php echo lang('now'); ?></div><img
                            src="front-end/assets/5f16ec24d8bd7908a5d24625/5f3d46263a5ec7752b5a63df_Arrow_purple.svg"
                            width="32" height="32" alt="" class="c-button__icon is--large" />
                    </a>
                </div>
                ...
                <div id="w-node-_3d519ce2-0b41-21a9-a84a-aeb7e9fbb872-fd5d4922" class="cs-quote c-card c-card-mp">
                    <div>
                        ...
                        <div class="g2-stars-link">
                            ...
                            <img
                                src="<?php echo $settings->team_commentator_image; ?>"
                                loading="lazy" alt="" class="image-7" />
                        </div>
                    </div>
                </div>
                <div id="w-node-_86c0b435-72b0-dbc6-df01-3314eb98eefd-fd5d4922" class="c-quote__author__name c-quote__cs"><span
                        class="text-span-2">
                        ...
                        <form action="frontend/send" id="sendEmail" enctype="multipart/form-data" method="POST" class="hs-form stacked hs-form-private hsForm_93389280-7d5f-4a00-a4a2-6b177ad9e886 hs-form-93389280-7d5f-4a00-a4a2-6b177ad9e886 hs-form-93389280-7d5f-4a00-a4a2-6b177ad9e886_568798ab-3c3f-4cfe-9689-3eba2e30f0f0" data-form-id="93389280-7d5f-4a00-a4a2-6b177ad9e886" data-portal-id="7012252" data-reactid=".hbspt-forms-0">
                            ...
                            <fieldset class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <legend class="hs-field-desc hs_field_desc"></legend>
                                    <div class="input">
                                        <textarea class="form-control" name="msg" value="" rows="50">  </textarea>
        ...
        <div class="l-footer">
            <div class="l-section is--footer">
                <div class="l-grid__general">
                    ...
                    <a
                        id="w-node-_4089167e-76e8-9def-ac74-3faa82bcf21d-2df6d2bd" aria-current="page"
                    ...
                    <ul id="w-node-_74a72201-6d63-7a78-a5cf-c130da42b5c8-2df6d2bd" role="list"
                        class="c-footer-list w-list-unstyled">
                    ...
                    <ul id="w-node-fc700cf1-12f3-3b80-fcc9-a265950b4a6d-2df6d2bd" role="list" class="c-footer-list w-list-unstyled">
                        ...
                        <li class="c-footer-list-item">
                            ...
                            <a href="<?php echo $settings->skype_id; ?>" target="_blank" class="c-footer-menu__nav-link"><?php echo lang('skype'); ?></a></li>
                    </ul>
                    <ul id="w-node-ac13c2de-2c06-f989-2891-b3a51b6647d8-2df6d2bd" role="list" class="c-footer-list w-list-unstyled">

                        <li class="c-footer-list-item"><a href="frontend#book" class="c-button__primary w-inline-block"
                                                          data-ix="button-icon">
                                <div class="c-button__text"><?php echo lang('register_hospital'); ?> </div><img
                                    src="front-end/assets/5f16ec24d8bd7908a5d24625/5f3d419ec0cff23f8b7b1a45_Arrow_white.svg"
                                    width="48" height="48" alt="" class="c-button__icon is--large" />
        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" data-doc-height="1" role="banner"
            ...
            <div class="navigation-banner">
                <div class="text-block-101">
                    <span class="text-span-4"><?php echo lang('new'); ?>:</span> <span class="span_color"> <?php echo $settings->block_1_text_under_title; ?> →</span></div></div>
            <div class="l-nav-section__grid w-container">
                <a href="frontend#cover"
                   id="w-node-ebd691a6-3a22-9b70-2dae-f440aac1582d-aac15824" aria-current="page"
                   class="c-nav-logo w-nav-brand w--current w_current_width"><?php
                       if (!empty($settings->logo)) {
                           if (file_exists($settings->logo)) {
                               echo '<img width="200" src=' . $settings->logo . '>';
        ...
        <script src="front-end/assets/js/jquery-3.5.1.min.dc5e7f18c85de7.js?site=5f16ec24d8bd7908a5d24625"
...
<?php if (!empty($settings->chat_js)) { ?>
    <script type="text/javascript">var chat_js = '<?php echo trim($settings->chat_js); ?>';</script>
