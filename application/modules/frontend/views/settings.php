                                        ...
                                        <div class="panel panel-default"> 
                                            ...
                                            <div id="collapseFive" class="panel-collapse collapse" aria-expanded="false">
                                                <div class="panel-body">
                                                    <div class="form-group col-md-12">
                                                        <div class="form-group col-md-12">
                                                            <h4> <label for="exampleInputEmail1"><?php echo lang('header_section'); ?> </label></h4><hr>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="form-group col-md-12">
                                                            <h4> <label for="exampleInputEmail1"><?php echo lang('section_1'); ?> </label></h4><hr>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="exampleInputEmail1"><?php echo lang('title'); ?> </label>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="form-group col-md-12">
                                                            <h4> <label for="exampleInputEmail1"><?php echo lang('section_2'); ?> </label></h4><hr>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="exampleInputEmail1"><?php echo lang('title'); ?> </label>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="form-group col-md-12">
                                                            <h4> <label for="exampleInputEmail1"><?php echo lang('section_3'); ?> </label></h4><hr>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="exampleInputEmail1"><?php echo lang('title'); ?> </label>
                                        ...
                                        <div class="panel panel-default"> 
                                            ...
                                            <div id="collapseSeven" class="panel-collapse collapse" aria-expanded="false">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="form-group col-md-12">
                                                            <h4> <label for="exampleInputEmail1"><?php echo lang('comment_section'); ?>  </label></h4><hr>
                                                        </div>
                                                        <div class="form-group col-md-6">
