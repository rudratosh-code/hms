...
class Service extends MX_Controller {
    ...
    public function index() {
        ...
        $this->load->view('frontend/service/service', $data);
        $this->load->view('home/footer'); 
    }

    public function addNewView() {
        $this->load->view('home/dashboard'); 
        $this->load->view('frontend/service/add_new');
        $this->load->view('home/footer'); 
    }
    ...
    public function addNew() {
        ...
        if ($this->form_validation->run() == FALSE) {
            if (!empty($id)) {
                redirect("frontend/service/editService?id=$id");
            } else {
                $data['setval'] = 'setval';
                $this->load->view('home/dashboard'); 
                $this->load->view('frontend/service/add_new', $data);
                $this->load->view('home/footer'); 
            }
        } else {
